...
app.use(express.static(path.join(__dirname, "dist", "weather-angular")))
...
openWeatherMapRouter.get("*", async (req, res) => {
  try {
    ...
    const openWeatherApiUrl = 'http://api.openweathermap.org/data/2.5/onecall' +
...
app.get("*", function (req, res) {
  ...
  res.sendFile(path.join(__dirname, "dist", "weather-angular", "index.html"))
})
